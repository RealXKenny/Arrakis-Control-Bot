...
describe("music playback progress", () => {
  it("formats bounded track progress and clamps stale positions", () => {
    expect(playbackProgress(90_000, 240_000, false)).toBe("▶️  **1:30**  ━━━━━━━●────────────  **4:00**  🔊");
    expect(playbackProgress(300_000, 240_000, false)).toBe("▶️  **4:00**  ━━━━━━━━━━━━━━━━━━━●  **4:00**  🔊");
    expect(playbackProgress(0, 0, false)).toBeNull();
  });

  it("labels streams and formats hour-long recordings", () => {
    expect(playbackProgress(0, 0, true)).toBe("▶️  🔴 **LIVE**  🔊");
    expect(playbackProgress(0, 60_000, false, true)).toContain("⏸️");
