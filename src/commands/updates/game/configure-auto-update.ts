...
class ConfigureAutoUpdateCommand extends Command {
  public constructor(context: Command.LoaderContext, options: Command.Options) {
    super(context, { ...options, name: "configure-auto-update", description: UPDATE_ACTIONS["configure-auto-update"].description, preconditions: ["InteractionRateLimit", "OwnerRoleOnly"] });
  }
...
export { ConfigureAutoUpdateCommand, data, execute };
