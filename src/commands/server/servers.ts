...
const command = {
  ...
  async execute(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    try {
      ...
      container.logger.error(`Unable to retrieve Advin VPS servers. ${errorDetails.message}`, error);
...
class ServersCommand extends Command {
  public constructor(context: Command.LoaderContext, options: Command.Options) {
    super(context, { ...options, name: "servers", description: "List your Advin VPS servers.", preconditions: ["InteractionRateLimit"] });
  }
