...
class StatusCommand extends Command {
  public constructor(context: Command.LoaderContext, options: Command.Options) {
    super(context, { ...options, name: "status", description: "Show the current Dune server status.", preconditions: ["InteractionRateLimit"] });
  }
...
export { StatusCommand, parseServices };
