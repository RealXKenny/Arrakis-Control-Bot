...
class ServicesCommand extends Command {
  public constructor(context: Command.LoaderContext, options: Command.Options) {
    super(context, { ...options, name: "services", description: "List Dune server services and their status.", preconditions: ["InteractionRateLimit", "OwnerRoleOnly"] });
  }
...
export { ServicesCommand, data, execute, normalizeServiceRows };
