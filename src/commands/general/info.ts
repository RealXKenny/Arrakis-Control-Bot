    ...
    .addTextDisplayComponents((text) =>
      text.setContent(
        [
          ...
          `**Registered commands:** ${client.stores.get("commands").size}`,
        ].join("\n"),
      ),
    )
...
class InfoCommand extends Command {
  public constructor(context: Command.LoaderContext, options: Command.Options) {
    super(context, { ...options, name: "info", description: "View information about this bot.", preconditions: ["InteractionRateLimit"] });
  }
