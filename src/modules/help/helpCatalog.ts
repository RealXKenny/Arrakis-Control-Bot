...
const LEGACY_CATEGORIES: readonly HelpCategory[] = [
  ...
  { id: "community", label: "Community & World", description: "Players, profiles, levels, the market, and Arrakis events.", emoji: "🏜️", access: "Everyone", commands: [{ name: "players" }, { name: "profile" }, { name: "level rank" }, { name: "level leaderboard" }, { name: "achievements" }, { name: "level event schedule", access: "Staff" }, { name: "level event status", access: "Staff" }, { name: "level event stop", access: "Staff" }, { name: "level roles status", access: "Staff" }, { name: "market" }, { name: "storm" }, { name: "voice" }, { name: "music" }, { name: "player catalog", description: "Search bundled item, skill, vehicle, journey, augment, XP, region and market references." }] },
  ...
  { id: "server-monitoring", label: "Server Monitoring", description: "Live Dune and VPS status information.", emoji: "📡", access: "Everyone", commands: [{ name: "status" }, { name: "servers" }, { name: "server-usage" }] },
